...
current_information: |-
  ...
  The Scalby Charity Walk takes place each Easter Monday, following a circular route through Scalby, Burniston and Cloughton. Registration, the start time, charity partner and any route updates are published on the Walk Bookings page for each new year.

  Walkers can take part competitively or at their own pace. Fancy dress is encouraged, and beer can always be replaced with a soft drink.
history_chapters:
  -
  ...
  -
    heading: "The original bet at the Plough"
    content: |-
...
callout_heading: Walk bookings
callout_text: Read the latest practical information and register when the next walk opens.
callout_link: entry::walk-bookings
callout_label: Walk bookings
seo_description: Plan the Scalby Charity Walk and discover the Easter Monday tradition that began with a pub bet in 1959.
---
