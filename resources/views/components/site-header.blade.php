...
<header class="relative z-50 border-b border-hedge-900/10 bg-cream-50/95 backdrop-blur-sm">
    ...
    <div class="mx-auto flex max-w-7xl items-center justify-between gap-6 px-5 py-4 sm:px-8">
                ...
                @foreach($navigation as $item)
                    ...
                    <li class="relative group">
                        ...
                        @if($children->isNotEmpty())
                            <div class="invisible absolute top-full left-0 z-30 w-56 translate-y-1 pt-2 opacity-0 transition duration-200 group-hover:visible group-hover:translate-y-0 group-hover:opacity-100 group-focus-within:visible group-focus-within:translate-y-0 group-focus-within:opacity-100">
        ...
        <details class="group relative z-20 lg:hidden">
            ...
            <nav class="absolute top-[calc(100%+0.75rem)] right-0 z-30 w-[min(21rem,calc(100vw-2.5rem))] border border-hedge-900/15 bg-cream-50 p-3 shadow-soft" aria-label="Mobile navigation">
    ...
    <x-bunting class="absolute inset-x-0 top-full" />
</header>
