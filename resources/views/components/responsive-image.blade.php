...
@if($asset)
    <img
        src="{{ glide($asset, ['w' => $width, 'h' => $height, 'q' => 82, 'fm' => 'webp']) }}"
        srcset="{{ glide($asset, ['w' => 640, 'h' => round(640 * $height / $width), 'q' => 80, 'fm' => 'webp']) }} 640w, {{ glide($asset, ['w' => $width, 'h' => $height, 'q' => 82, 'fm' => 'webp']) }} {{ $width }}w"
        sizes="{{ $sizes }}"
